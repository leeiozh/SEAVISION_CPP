...
// TODO: предполагается сделать класс телескопа с параметрами, функциями вычисления положения и самих картинок, но над этим решением точно нужно долго думать
